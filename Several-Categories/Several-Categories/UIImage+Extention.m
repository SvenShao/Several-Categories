...
//获取视频帧
+ (UIImage *)generateVideoThumb:(NSData *)data;
{
    ...
    AVURLAsset *urlAsset = [AVURLAsset URLAssetWithURL:[NSURL fileURLWithPath:filepath] options:opts];
    
    AVAssetImageGenerator *generator = [AVAssetImageGenerator assetImageGeneratorWithAsset:urlAsset];
    generator.appliesPreferredTrackTransform = YES;
    generator.maximumSize = CGSizeMake(120.0, 120.0);
    NSError *error = nil;
